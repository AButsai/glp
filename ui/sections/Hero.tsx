...
// 			<Container>
// 				<div
// 					className=' grid grid-cols-1 items-center gap-8 overflow-hidden rounded-3xl bg-linear-to-br from-[#DCF6EC] via-[#D3EDE3] to-[#C5E1D3] p-4 sm:p-6 md:p-8 lg:grid-cols-[1fr_1fr] lg:gap-10 lg:p-10 xl:gap-14 xl:p-12 justify-center
// 					'
// 				>
// 					{/* Content */}
...
// 						{/* Title */}
// 						<h1
// 							className=' mb-5 font-serif text-[38px] leading-[0.98] sm:text-5xl md:text-6xl lg:text-[56px] xl:text-7xl
// 							'
// 						>
// 							The only GLP-1
// 							<br />
// 							company who{' '}
// 							<span className='italic text-[#0F7B5C]'>locks your price</span> in
// 							for life.
// 						</h1>
...
// 								'
// 							>
// 								<div className='flex items-center gap-2 pr-12 sm:gap-3 sm:pr-20'>
