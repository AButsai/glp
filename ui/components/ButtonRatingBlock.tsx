	...
	return (
		<>
			<div className='mt-8 flex items-stretch justify-center gap-4'>
				<LinkQuiz
					title='Get started'
					className='bg-[#0F7B5C] text-white  rounded-4xl px-4 py-3 text-lg hover:bg-[#0b5b44] lg:w-50'
				/>
				<LinkQuiz
					title='See pricing'
					className='bg-white text-black rounded-4xl px-4 py-3 text-lg border border-gray-300 hover:bg-[#0F7B5C] lg:w-50 hover:text-white '
				/>
			</div>
			<div className='my-5'>
				<GuaranteeBar />
