...
export const metadata: Metadata = {
	title: 'HIPAA Notice of Privacy Practices | VelmoRx',
	description:
		'VelmoRx Notice of Privacy Practices describing how we may use and disclose your Protected Health Information (PHI).',
}
...
export default function HipaaNoticePage() {
	return (
		...
		>
			<h2>Notice of Privacy Practices for Protected Health Information (PHI)</h2>
			<p>
				This Notice of Privacy Practices (&quot;Notice&quot;) describes how{' '}
				{COMPANY.legalName} d/b/a VelmoRX (&quot;we&quot;, &quot;us&quot;, or
			...
			<p>
				<strong>a. Treatment:</strong> We may use and disclose your PHI to
				provide, coordinate, or manage your healthcare and related services.
				This may include communication with other healthcare providers about
				your treatment and coordinating your care with other providers.
			</p>
			<p>
				<strong>b. Payment:</strong> We may use and disclose your PHI to
			...
			<p>
				<strong>c. Healthcare Operations:</strong> We may use and disclose
			...
			<p>
				<strong>d. As Required by Law:</strong> We may use and disclose your
				PHI when required to do so by federal, state, or local law.
			</p>
			<p>
				<strong>e. Public Health and Safety:</strong> We may use and disclose
				your PHI to prevent or control disease, injury, or disability, to
				report child abuse or neglect, to report reactions to medications or
				problems with products, and to notify persons who may have been
				exposed to a communicable disease or may be at risk of spreading a
				disease or condition.
			</p>
			<p>
				<strong>f. Health Oversight Activities:</strong> We may disclose your
				PHI to health oversight agencies for activities authorized by law,
				such as audits, investigations, inspections, and licensure.
			</p>
			<p>
				<strong>g. Judicial and Administrative Proceedings:</strong> We may
				disclose your PHI in response to a court or administrative order,
				subpoena, discovery request, or other lawful process.
			</p>
			<p>
				<strong>h. Law Enforcement:</strong> We may disclose your PHI for law
			...
			<p>
				<strong>i. Research:</strong> We may use and disclose your PHI for
			...
			<p>
				<strong>a. Right to Inspect and Copy:</strong> You have the right to
				inspect and copy your PHI that we maintain, with certain exceptions.
				To request access, submit a written request to our Privacy Officer.
				We may charge a reasonable fee for the costs of copying, mailing, or
				other supplies associated with your request.
			</p>
			<p>
				<strong>b. Right to Amend:</strong> You have the right to request an
			...
			<p>
				<strong>c. Right to an Accounting of Disclosures:</strong> You have
				the right to request an accounting of disclosures of your PHI made by
				us in the past six years, except for disclosures made for treatment,
				payment, or healthcare operations, and certain other disclosures. To
				request an accounting, submit a written request to our Privacy
				Officer.
			</p>
			<p>
				<strong>d. Right to Request Restrictions:</strong> You have the right
				to request a restriction on our use or disclosure of your PHI for
				treatment, payment, or healthcare operations. We are not required to
				agree to your request but will consider it. To request a
				restriction, submit a written request to our Privacy Officer,
				specifying the restriction you are requesting and to whom it
				applies.
			</p>
			<p>
				<strong>e. Right to Request Confidential Communications:</strong> You
			...
			<p>
				<strong>f. Right to a Paper Copy of This Notice:</strong> You have
				the right to receive a paper copy of this Notice, even if you have
				agreed to receive it electronically. To obtain a paper copy of this
				Notice, contact our Privacy Officer.
			</p>
			<p>
				<strong>g. Right to be Notified of a Breach:</strong> You have the
				right to be notified in the event that we discover a breach of your
				PHI.
			</p>
			...
			<p>
				...
				Rule (45 CFR 164). This includes the use of Secure-Socket Layer
				(SSL) or equivalent technology for the transmission of PHI, as well
				as adherence to all applicable security standards for online
			...
			<p>
				...
				states. Rights of Specific Jurisdictions within the US: Certain
			...
			<p>
				<strong>a. Right to Access:</strong> In addition to the rights
			...
			<p>
				<strong>b. Right to Restrict Certain Disclosures:</strong> California
				residents have the right to request restrictions on certain
				disclosures of their PHI to health plans if they paid out-of-pocket
				for a specific healthcare item or service in full. To request such a
				restriction, submit a written request to our Privacy Officer.
			</p>
			<p>
				<strong>
					c. Confidentiality of Medical Information Act (CMIA):
				</strong>{' '}
				California residents are protected by the Confidentiality of Medical
			...
			<p>
				<strong>d. Marketing and Sale of PHI:</strong> California residents
			...
			<p>
				<strong>e. Minor&apos;s Rights:</strong> If you are a minor (under
				the age of 18), you have the right to request that certain
				information related to certain sensitive services, such as
				reproductive health, mental health, or substance use disorder
				treatment, not be disclosed to your parent or guardian without your
				consent. To request a restriction on the disclosure of such
				information, submit a written request to our Privacy Officer.
			</p>
			<p>
			...
			<h2>
				{COMPANY.legalName} d/b/a VelmoRX Privacy Policy: Notice of Privacy
				Practices for Protected Health Information (PHI) &ndash;
			...
			<p>The following are examples of a few states with additional privacy protections:</p>
			...
			<p>
				...
				HIV/AIDS-related information, and substance abuse treatment
				records. We will obtain written consent before disclosing such
				information, even for treatment, payment, or healthcare operations.
				We also implement specific security measures to protect electronic
				PHI, as required by Florida law.
			</p>
			...
			<h3>Massachusetts</h3>
			<p>
				For residents of Massachusetts, we comply with
				Massachusetts&apos;s specific privacy laws related to mental health
				records, HIV/AIDS-related information, and genetic testing results.
