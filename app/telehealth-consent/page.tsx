...
export const metadata: Metadata = {
	title: 'Consent to Telehealth | VelmoRx',
	description: 'VelmoRx Consent to Telehealth for asynchronous telemedicine visits.',
}

export default function TelehealthConsentPage() {
	return (
		<LegalPage title='Consent to Telehealth'>
			<p>
				Thank you for choosing Bask Health Inc. (Bask) and Beluga Health,
				P.A. (&quot;Beluga&quot;)! You are viewing this form because you
				have elected to engage in asynchronous telemedicine visits with a
				Beluga healthcare practitioner via Bask. Your practitioner is a
				board-certified physician licensed in your state.
			</p>
			<p>
				<strong>
					By clicking &quot;I Agree,&quot; I ACKNOWLEDGE I HAVE READ AND
					UNDERSTAND THE TERMS PRESENTED BELOW, AND UNDERSTAND THE RISKS AND
					BENEFITS OF ASYNCHRONOUS TELEMEDICINE, AND BY ACCEPTING THESE
					TERMS OF USE I HEREBY GIVE MY INFORMED CONSENT TO PARTICIPATE IN
					ASYNCHRONOUS TELEMEDICINE UNDER THESE TERMS.
				</strong>
			</p>
			...
			<p>
				...
				located in a different location than your healthcare practitioner.
				Beluga allows you to receive treatment from a healthcare
				practitioner without having to travel to another location or
				schedule a separate appointment and helps you avoid long wait times
				that you might otherwise experience at an in-person visit.
			</p>

			<h2>What is Asynchronous Telemedicine?</h2>
			<p>
				Asynchronous telemedicine is one way to deliver telemedicine.
				Asynchronous communication is often referred to as
				&quot;store-and-forward&quot; communication, where participants
				submit and collect data at different times. An example of
				asynchronous communication is a telemedicine encounter with a
				healthcare practitioner that involves sending photos, video, or
				other communications via email or text message.
				&quot;Asynchronous&quot; means &quot;not occurring at the same
				time&quot; and is different from &quot;synchronous&quot;
			...
			<p>
				Beluga&apos;s platform (&quot;Platform&quot;), in particular,
				allows for the following asynchronous telemedicine services: 1)
				text-based healthcare practitioner-patient interactions through
				short message service (&quot;SMS&quot;) and multimedia messaging
				service (&quot;MMS&quot;) communications; and 2) secure information
				collection through asynchronous store-and-forward patient
				questionnaires.
			</p>

			<h2>What are the Possible Risks to Using Asynchronous Telemedicine?</h2>
			<p>
				As with any medical treatment, there are potential risks
				associated with the use of asynchronous telemedicine. Beluga
				believes that the likelihood of these risks materializing is very
				low.
			</p>
			<p>These risks may include, without limitation, the following:</p>
			<ul>
				<li>
				...
				<li>
					...
					your Personal Data (as defined in the Beluga{' '}
					<a
						href='https://bask.health/privacy'
						target='_blank'
						rel='noopener'
					>
						Privacy Policy
					</a>
					) WILL NOT BE MONITORED 24/7. If you think you are experiencing a
			...
			<ul>
				<li>
					...
					we protect your privacy, please read the Beluga{' '}
					<a
						href='https://bask.health/privacy'
						target='_blank'
						rel='noopener'
				...
				<li>
					...
					with other individuals in accordance with the Beluga{' '}
					<a
						href='https://bask.health/privacy'
						target='_blank'
						rel='noopener'
			...
			<p>
				...
				), appointments, or similar matters related to your telemedicine
				encounters using the contact information you have provided. Any
				calls or texts to you may be placed using an auto-dialer or a
				pre-recorded or artificial voice, even if your number is on a
				do-not-call list. Your phone carrier&apos;s normal rates may apply.
				This is consent, not a condition of purchase. You may revoke this
				consent at any time by emailing us at{' '}
				<a href='mailto:admin@belugahealth.com'>admin@belugahealth.com</a>.
			</p>
			<p>
				This Asynchronous Telemedicine Informed Consent is valid during
				your entire treatment with Beluga.
			</p>
		</LegalPage>
	)
}
